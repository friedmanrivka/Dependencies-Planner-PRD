...
//                     <TableHead>
//                       <TableRow>
//                         <TableCell className="highlight-header"><div className='columnName'>Requestor Group</div><ExpandCircleDownIcon className="table-header-icon" /></TableCell>
//                         <TableCell className="highlight-header"><div className='columnName'>Requestor Name</div><ExpandCircleDownIcon className="table-header-icon" /></TableCell>
//                         <TableCell className="highlight-header"><div className='columnName'>Title</div><FormatAlignLeftIcon className="table-header-icon"/></TableCell>
//                         <TableCell className="highlight-header"><div className='columnName'>Planned</div><ExpandCircleDownIcon className="table-header-icon"/></TableCell>
//                         <TableCell className="highlight-header"><div className='columnName'>Description</div><FormatAlignLeftIcon className="table-header-icon"/></TableCell>
//                         <TableCell className="highlight-header"><div className='columnName'>Priority</div><ExpandCircleDownIcon className="table-header-icon"/></TableCell>
//                         <TableCell className="highlight-header"><div className='columnName'>Final Decision</div><ExpandCircleDownIcon className="table-header-icon" /></TableCell>
//                         {showGroups && group.map((item, index) => (
//                           <TableCell className="highlight-header" key={index}>{item}</TableCell>
//                         ))}
//                         <TableCell className="highlight-header"><div className='columnName'>Comments</div><FormatAlignLeftIcon className="table-header-icon"/></TableCell>
//                         <TableCell className="highlight-header"><div className='columnName'>Jira Link</div><LinkIcon className="table-header-icon"/></TableCell>
//                       </TableRow>
//                     </TableHead>
//                     <TableBody>
      ...
      <div className="container">
        <div className="sidebar">
          <List>
            ...
            <ListItem>
              <FormControl fullWidth>
                <InputLabel id="filter-involved-name-label">Filter by Involved Group</InputLabel>
                <Select
                  multiple
                  value={filterInvolvedName}
                  label="Filter by Involved Group"
