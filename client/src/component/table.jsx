...
// //   startIcon={<AddCircleOutlineIcon className="hat-button-icon" />}
// //   onClick={showModal}
// // >
// //   Add Request
// // </Button>
...
//   palette: {
//     primary: {
//       main: '#5A00E1', // Dark purple color from your logo
//     },
//     secondary: {
//       main: '#00C2FF', // Lighter blue color for accents
//     },
//   },
//   typography: {
//     fontFamily: 'Arial, sans-serif',
...
//                         </TableCell>
//                         <TableCell className="highlight-header">
//                           <div className='columnName'>Show Group</div>
//                           <IconButton onClick={toggleGroups} color="inherit">
//                             {showGroups ? <VisibilityOffIcon /> : <VisibilityIcon />}
//                           </IconButton>
//                         </TableCell>
