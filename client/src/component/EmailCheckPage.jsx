...
const EmailCheckPage = () => {
  ...
  //   }
  // };
  console.log('calling checkemailexists with',email);
//   const { exists, isAdmin } = await checkEmailExists(email);
// console.log('result from checkemailexists',{exists, isAdmin})
const {success,message } = await checkEmailExists(email);
if (success) {
  console.log('Login successful, token set in cookie');
  navigate('/table'); // או לכל מסלול אחר
} else {
  console.error('Error: Email not found');
  setErrorMessage(message || 'Email not found');
}
...
//     localStorage.setItem('isAdmin',isAdmin.toString());
//     navigate('table');
    // If the user is an admin, navigate to the admin dashboard, otherwise to the user dashboard
    // if (isAdmin) {
    //   navigate('/admin-dashboard');
    // } else {
    //   // navigate('/user-dashboard');
